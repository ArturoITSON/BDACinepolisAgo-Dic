...
public class SalaGuardarDTO {
    ...
    public SalaGuardarDTO() {
    }

    public SalaGuardarDTO(int id, String nombre, int asientos_disponibles, float precio, int minutosLimpiza, int sucursa_id) {
        this.id = id;
        this.nombre = nombre;
